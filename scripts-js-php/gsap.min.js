...
// let w = document.querySelector(".registration__illustration-part-1").getBoundingClientRect().width;
// let h = document.querySelector(".registration__illustration-part-1").getBoundingClientRect().height;
// let stampShiftXPercent = (-145 / w) * 100;
// console.log(stampShiftXPercent)



tlRP.to(rpStampHighBack, {xPercent:-28.8, y: -20, ease: "expo.inOut"}, 1);
tlRP.to(rpStampLowBack, {xPercent:-28.8, y: -20, ease: "expo.inOut"}, 1);
tlRP.to(rpStampHighFront, {xPercent:-28.8, y: -20, ease: "expo.inOut"}, 1);
tlRP.to(rpStampLowFront, {xPercent:-28.8, y: -20, ease: "expo.inOut"}, 1);

tlRP.to(rpStampHighBack, {y:55, ease: "expo.inOut", duration: 1.3});
tlRP.to(rpStampLowBack, {y:55, ease: "expo.inOut", duration: 1.3}, "<");
tlRP.to(rpStampHighFront, {y:55, ease: "expo.inOut", duration: 1.3}, "<");
tlRP.to(rpStampLowFront, {y:55, ease: "expo.inOut", duration: 1.3}, "<");
...
tlRP.to(rpStampHighBack, {y: -20, ease: "expo.out", duration: 1.6});
tlRP.to(rpStampLowBack, {y: -20, ease: "expo.out", duration: 1.6}, "<");
tlRP.to(rpStampHighFront, {y: -20, ease: "expo.out", duration: 1.6}, "<");
tlRP.to(rpStampLowFront, {y: -20, ease: "expo.out", duration: 1.6}, "<");

tlRP.to(rpStampHighBack, {xPercent:0, y:0, ease: "expo.inOut"}, "-=35%");
tlRP.to(rpStampLowBack, {xPercent:0, y:0, ease: "expo.inOut"}, "<");
tlRP.to(rpStampHighFront, {xPercent:0, y:0, ease: "expo.inOut"}, "<");
tlRP.to(rpStampLowFront, {xPercent:0, y:0, ease: "expo.inOut"}, "<");
